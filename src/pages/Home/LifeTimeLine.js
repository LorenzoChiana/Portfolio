                ...
                {status => (
                    <div>
                        ...
                        <VerticalTimelineElement
                                ...
                                icon={<WorkIcon />}
                            >
                            <h3 className="vertical-timeline-element-title">Looking for a new experience</h3>
                        </VerticalTimelineElement>
                        <VerticalTimelineElement
                                className="vertical-timeline-element--education"
                                date="July 2021"
                            ...
                            >
                                ...
                                <p>
                                I graduated in 2021 in Engineering and Computer Science from Bologna University in Cesena, Italy.
                                </p>
                                <p>
                                Thesis: "Study and evaluation of an RTLS algorithm for indoor positioning"
                                </p>
                                <p>
                                Dissertation/thesis subject: "Business analytics"
                                </p>
                                <p>
                            ...
                            >
                                ...
                                <p>
                                Thesis: "Hospital 4.0: The IoT challenges in hospital field"
                                </p>
                                <p>
                                Dissertation/thesis subject: "Programming of embedded systems"
                                </p>
                            </VerticalTimelineElement>
                            <VerticalTimelineElement
